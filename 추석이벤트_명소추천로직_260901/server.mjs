...
async function recommend(category,wish,{manualRetry=false}={}){
...
const server=http.createServer(async(req,res)=>{try{
  if(req.method==='POST'&&req.url==='/api/recommend'){
    ...
    const key=requestKey(b.category,b.wish);
    ...
    try{
      const result=await recommend(b.category,b.wish,{manualRetry});
