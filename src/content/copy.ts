...
export const LETTER = {
  arrivedWin:
    "달님이 선물과 함께 답장을 보냈어요\n편지를 눌러 열어보세요",
  /** 성공했지만 경품이 소진된 경우. 선물을 언급하지 않는다. */
  arrivedSuccess: "달님이 답장을 보냈어요\n편지를 눌러 열어보세요",
  arrivedLose: "달님에게 답장이 왔어요\n편지를 눌러 열어보세요",
  from: "FROM. 달님",
  bodyWin:
    "세 번의 도전을 모두 소중히 받았어요. 이렇게 정성껏 밤하늘을 건너온 소원은 오랜만이에요. 당신의 소원이 머물기 좋은 곳들을 적어 보내요. 부디 좋은 일만 가득하길.",
  bodyLose:
    "종이비행기는 밤바람에 잠시 길을 잃었지만, 당신의 간절한 마음은 제게 닿았어요. 그 소원이 이루어지길 바라며 어울리는 곳들을 적어 보내요.",
