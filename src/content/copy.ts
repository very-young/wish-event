...
export const INTRO = {
  ...
  /**
   * 카카오로 이동해 로그인하는 동안 버튼에 보여준다.
   * 이미 동의한 사람은 즉시 되돌아오지만 그 왕복에 1~2초 걸린다.
   */
  loggingIn: "로그인 중…",
  /** 카카오에서 돌아와 참여 자격을 확인하는 동안 */
  preparing: "소원을 빌 준비를 하고 있어요",
  periodLabel: "이벤트 기간",
  /*
...
export const RETRY_SHARE = {
  ...
  /*
   * 화면 대기가 끝났을 때. "실패"라고 하지 않는다.
   * 티켓은 아직 유효할 수 있어 방금 보낸 공유가 인정될 수 있다.
   */
  timeout:
    "전송 확인이 늦어지고 있어요. 이미 보내셨다면 잠시 뒤 다시 시작해 주세요.",
...
/*
 * 개인정보 안내 문구는 두지 않는다 (기획 결정).
 * 카카오 로그인 동의 화면과 네이버폼 제출 시 동의로 갈음한다.
 */
