...
export const LETTER = {
  ...
  from: "FROM. 달님",
  bodyWin:
    "세 번의 도전을 모두 소중히 받았어요. 이렇게 정성껏 밤하늘을 건너온 소원은 오랜만이에요. 작은 선물과 함께, 당신의 소원이 머물기 좋은 곳들을 적어 보내요. 부디 좋은 일만 가득하길.",
  bodyLose:
    "종이비행기는 밤바람에 잠시 길을 잃었지만, 당신의 소원은 종이에 적힌 그 순간 이미 저에게 닿아 있었어요. 그 마음을 담아, 소원이 이루어지기 좋은 곳들을 적어 보내요. 언제든 다시 밤하늘을 올려다봐 주세요.",
